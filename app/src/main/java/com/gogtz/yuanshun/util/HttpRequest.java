...
package com.gogtz.yuanshun.util;

import com.gogtz.yuanshun.application.GogtzApplication;
...
//	private static final String TAG = "HttpRequest";
	...
	/**基础URL，这里服务器设置可切换*/
	public static final String URL_BASE = SettingUtil.getCurrentServerAddress(GogtzApplication.getInstance());
	...
	public static void login(final String phone, final String password,
		...
		HttpManager.getInstance().post(paramList, "http://www.baidu.com", requestCode, listener);
	}
	 ...
	 * @param listener
	 */
	public static void getGpsInfo(final int requestCode, final OnHttpResponseListener listener) {
		List<Parameter> paramList = new ArrayList<Parameter>();
//		addExistParameter(paramList, KEY_CURRENT_USER_ID, GogtzApplication.getInstance().getCurrentUserId());
		addExistParameter(paramList, "cd", "ec7acd16-b243-4c40-8c7a-f9a7a0fa0eb3");

		HttpManager.getInstance().get(paramList, "http://events.gogtz.com/gogtz-race/www/view/remote/race", requestCode, listener);
	}
