package com.gogtz.yuanshun.zxing;
...
import com.gogtz.yuanshun.zxing.camera.CameraManager;
import com.gogtz.yuanshun.zxing.decode.DecodeThread;
import com.gogtz.yuanshun.zxing.decode.PhotoScanHandler;
import com.gogtz.yuanshun.zxing.decode.RGBLuminanceSource;
import com.gogtz.yuanshun.zxing.utils.BeepManager;
import com.gogtz.yuanshun.zxing.utils.BitmapUtil;
import com.gogtz.yuanshun.zxing.utils.CaptureActivityHandler;
import com.gogtz.yuanshun.zxing.utils.InactivityTimer;
...
public class ScanManager implements SurfaceHolder.Callback{
	...
	void initCrop() {
		...
		Log.e(TAG, "cameraWidth: " + cameraWidth);
		Log.e(TAG, "cameraHeight: " + cameraHeight);
		...
		Log.e(TAG, "cropLeft: " + cropLeft);
		Log.e(TAG, "cropTop: " + cropTop);
		...
		Log.e(TAG, "containerWidth: " + containerWidth);
		Log.e(TAG, "containerHeight: " + containerHeight);
